...
<head>
    ...
    <meta name="token-code" content="{{isset(session()->get('userData')['token'])?substr(session()->get('userData')['token'],7):''}}">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('cArticleAdmin')}}"><i class="fa fa-circle-o"></i>Categories</a></li>
                        <li><a href="{{route('articleAdmin')}}"><i class="fa fa-circle-o"></i>List</a></li>
                    </ul>
                </li>
                <li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('cArticleAdmin')}}"><i class="fa fa-circle-o"></i>Brands</a></li>
...
<!-- AdminLTE App -->
<script src="{{asset('admin/js/other/adminlte.min.js')}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{asset('admin/js/other/demo.js')}}"></script>
</body>
</html>
